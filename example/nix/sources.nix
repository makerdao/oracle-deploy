...
let
  ...
  mkConfig = { sourcesFile ? if builtins.pathExists ./sources.json then ./sources.json else null
...
in mkSources (mkConfig { }) // { __functor = _: settings: mkSources (mkConfig settings); }
